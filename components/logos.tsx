...
export default function Logos() {
  return (
    <motion.div
      className="flex h-full w-full flex-col gap-2 pt-12 pb-12 md:pt-16 md:pb-24"
      ...
      >
        {logos.map((logo, index) => (
          <Link
            ...
            target="_blank"
            className="md:hover:bg-accent flex h-24 items-center justify-center rounded-lg border bg-zinc-900 p-8 transition-all duration-150 ease-in-out md:hover:border-zinc-700"
          >
            <Image
              src={logo.src}
              alt={logo.alt}
